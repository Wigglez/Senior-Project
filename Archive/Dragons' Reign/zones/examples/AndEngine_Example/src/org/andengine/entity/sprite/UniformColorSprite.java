...
import org.andengine.entity.sprite.vbo.LowMemoryUniformColorSpriteVertexBufferObject;
...
public class UniformColorSprite extends Sprite {
	...
	public UniformColorSprite(final float pX, final float pY, final float pWidth, final float pHeight, final ITextureRegion pTextureRegion, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pX, pY, pWidth, pHeight, pTextureRegion, new LowMemoryUniformColorSpriteVertexBufferObject(pVertexBufferObjectManager, UniformColorSprite.SPRITE_SIZE, pDrawType, true, UniformColorSprite.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}

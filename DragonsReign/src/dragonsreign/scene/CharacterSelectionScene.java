...
public class CharacterSelectionScene extends BaseScene implements IOnMenuItemClickListener
{
	...
	private Sprite charSelectBackground;
	...
	private void createBackground() {
		charSelectBackground = new Sprite(0, 0, resourcesManager.characterSelectBackground, vbom) {
			@Override
		...
		charSelectBackground.setPosition(0, 0);
		characterChildScene.attachChild(charSelectBackground);
	...
	private void createHUD() {
	    ...
	    ////////////////////////////////////////////////////////////////////////////////////
		classText[WARRIOR_ID] = new Text(250, 250, resourcesManager.whiteFont, "" ,150, new TextOptions(AutoWrap.WORDS,AUTOWRAP_WIDTH,HorizontalAlign.LEFT), vbom);
		classText[WARRIOR_ID].setText("Master of brute force melee combat, capable of frightening the foe with appearance alone.");
		
		classText[RANGER_ID] = new Text(250, 250, resourcesManager.whiteFont, "" ,150, new TextOptions(AutoWrap.WORDS,AUTOWRAP_WIDTH,HorizontalAlign.LEFT), vbom);
		classText[RANGER_ID].setText("Master of ranged attacks, capable of killing with pinpoint precision from afar.");
		
		classText[CLERIC_ID] = new Text(250, 250, resourcesManager.whiteFont, "" ,150, new TextOptions(AutoWrap.WORDS,AUTOWRAP_WIDTH,HorizontalAlign.LEFT), vbom);
		...
		*/
		...
		playerStats[WARRIOR_ID] = new Text(0, 0, resourcesManager.whiteFont, "", 150,
				new TextOptions(HorizontalAlign.LEFT), vbom);
		playerStats[RANGER_ID] = new Text(0, 0, resourcesManager.whiteFont, "", 150,
				new TextOptions(HorizontalAlign.LEFT), vbom);
		playerStats[CLERIC_ID] = new Text(0, 0, resourcesManager.whiteFont, "", 150,
				new TextOptions(HorizontalAlign.LEFT), vbom);
		/*
	...
	private void createMenuChildScene() {
	   ...
	   */
	    ...
	    */
	    ...
	    classSprite[RANGER_ID].setPosition(600, 20);
	    classSprite[CLERIC_ID].setPosition(600, 20);
	    //classSprite[KNIGHT_ID].setPosition(600, 20);
	    //classSprite[ASSASSIN_ID].setPosition(600, 20);
	    //classSprite[ENGINEER_ID].setPosition(600, 20);
	    //classSprite[MAGE_ID].setPosition(600, 20);

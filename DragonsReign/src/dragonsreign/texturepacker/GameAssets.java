...
//$TexturePacker:SmartUpdate:ed271faa6d7a607551fde8d6b85d88c2:1/1$


public interface GameAssets
{
	public static final int CENTER_DPAD_ID = 0;
	public static final int DOWN_DPAD_ID = 1;
	public static final int FADEBACKGROUND_ID = 2;
	public static final int LEFT_DPAD_ID = 3;
	public static final int RIGHT_DPAD_ID = 4;
	public static final int UP_DPAD_ID = 5;
	public static final int ARMOR_AMULET_ID = 6;
	public static final int ARMOR_HEAVYHELM_ID = 7;
	public static final int ARMOR_HEAVYLOWER_ID = 8;
	public static final int ARMOR_HEAVYUPPER_ID = 9;
	public static final int ARMOR_LIGHTHELM_ID = 10;
	public static final int ARMOR_LIGHTLOWER_ID = 11;
	public static final int ARMOR_LIGHTUPPER_ID = 12;
	public static final int ARMOR_MEDIUMHELM_ID = 13;
	public static final int ARMOR_MEDIUMLOWER_ID = 14;
	public static final int ARMOR_MEDIUMUPPER_ID = 15;
	public static final int ARMOR_RING_ID = 16;
	public static final int ARMOR_SHIELD_ID = 17;
	public static final int BACKPACK_ID = 18;
	public static final int CURRENTEQUIPMENTSLOTS_ID = 19;
	public static final int EXIT_ID = 20;
	public static final int HERO_ID = 21;
	public static final int INVENTORY_ID = 22;

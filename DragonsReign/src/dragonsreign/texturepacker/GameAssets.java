...
public interface GameAssets
{
	...
	public static final int LEFT_DPAD_ID = 4;
	public static final int RIGHT_DPAD_ID = 5;
	public static final int UP_DPAD_ID = 6;
	public static final int ARMOR_AMULET_ID = 7;
	public static final int ARMOR_HEAVYHELM_ID = 8;
	public static final int ARMOR_HEAVYLOWER_ID = 9;
	public static final int ARMOR_HEAVYUPPER_ID = 10;
	public static final int ARMOR_LIGHTHELM_ID = 11;
	public static final int ARMOR_LIGHTLOWER_ID = 12;
	public static final int ARMOR_LIGHTUPPER_ID = 13;
	public static final int ARMOR_MEDIUMHELM_ID = 14;
	public static final int ARMOR_MEDIUMLOWER_ID = 15;
	public static final int ARMOR_MEDIUMUPPER_ID = 16;
